<?php
/**
 * Runtime configuration parameters for the FAQ Shortcode.
 *
 * @package     PurpleProdigy\FAQ\Shortcode
 * @since       1.0.0
...
namespace PurpleProdigy\FAQ\Shortcode;

use PurpleProdigy\Polestar\Custom;

Custom\register_shortcode( FAQ_DIR . 'config/shortcode.php' );
